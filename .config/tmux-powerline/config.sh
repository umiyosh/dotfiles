...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/a14073/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/a14073/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/Users/a14073/.now_playing.log"
...
# tmux_session_info.sh {
	...
	# Enrich pane info: session:window.pane cmd [pane_title]
	export TMUX_POWERLINE_SEG_TMUX_SESSION_INFO_FORMAT="#S:#I.#P #{pane_current_command} [#{pane_title}]"
# }
...
# weather.sh {
    ...
    export TMUX_POWERLINE_SEG_WEATHER_LAT="35.6895"    # Tokyo
    export TMUX_POWERLINE_SEG_WEATHER_LON="139.6917"   # Tokyo
# }
